...
$category=DB::table('categories')->orderBy('id','desc')->skip(8)->first();
...
$add24=DB::table('adds')->where('page',1)->where('place',24)->orderBy('id','desc')->first();
$add25=DB::table('adds')->where('page',1)->where('place',25)->orderBy('id','desc')->first();

$add26=DB::table('adds')->where('page',1)->where('place',26)->orderBy('id','desc')->first();
$add27=DB::table('adds')->where('page',1)->where('place',27)->orderBy('id','desc')->first();
$add28=DB::table('adds')->where('page',1)->where('place',28)->orderBy('id','desc')->first();
...
@endphp
    ...
    <a href="{{$add24->link}}" class="mx-auto">
        <img src="{{asset($add24->img)}}" alt="{{$add24->link}}" class="m-auto mb-1 img-fluid">
    </a>
    </section>
            ...
            <div class="flex-box">
                ...
                {{-- <aside>
                      ...
                      <a href="{{$add28->link}}" class="mx-auto">
                          <img src="{{asset($add28->img)}}" alt="{{$add28->link}}" class="m-auto mb-1 img-fluid">
                      </a>
                  </div>
                        ...
                        <a href="{{$add25->link}}" class="mx-auto">
                            <img src="{{asset($add25->img)}}" alt="{{$add25->link}}" class="m-auto mb-1 img-fluid">
                        </a>
                    </div>
                          ...
                          <a href="{{$add26->link}}" class="mx-auto">
                              <img src="{{asset($add26->img)}}" alt="{{$add26->link}}" class="m-auto mb-1 img-fluid">
                          </a>
                      </div>
                            ...
                            <a href="{{$add27->link}}" class="mx-auto">
                                <img src="{{asset($add27->img)}}" alt="{{$add27->link}}" class="m-auto mb-1 img-fluid">
                            </a>
                        </div>
