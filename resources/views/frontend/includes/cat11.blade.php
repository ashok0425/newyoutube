...
$category=DB::table('categories')->orderBy('id','desc')->skip(9)->first();
...
$add29=DB::table('adds')->where('page',1)->where('place',29)->orderBy('id','desc')->first();
...
@endphp
    ...
    <a href="{{$add29->link}}" class="mx-auto">
        <img src="{{asset($add29->img)}}" alt="{{$add29->link}}" class="m-auto mb-1 img-fluid">
    </a>
    </section>
